...
public class ElevatorConstants {
    ...
    public static final double CORAL_STATION_POS = 7.9;
    ...
    // These were P & I prior to feed forward tuning
    ...
    // TODO - this was probably intended to limit current but is now clamping
    // voltage which is meaningless (voltage is -1 to 1).  Should probably
    // remove
