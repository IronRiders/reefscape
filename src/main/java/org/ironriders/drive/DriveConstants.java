...
public class DriveConstants {
    ...
    public static final double SWERVE_MAXIMUM_SPEED_TELEOP = 2; // m/s
    public static final double SWERVE_MAXIMUM_SPEED_AUTO = .5; // m/s these can probably be recombined for comp but
