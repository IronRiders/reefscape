...
public class DriveConstants {
    ...
    public static final double SWERVE_DRIVE_MAX_SPEED = 4; // m/s
    public static final double SWERVE_MAXIMUM_ANGULAR_VELOCITY_TELEOP = Math.PI * 3; // rad/s
    ...
    public static final double JOG_DISTANCE_INCHES = 0.2;
    public static final double JOG_SPEED = .1;
}
